...
var style_KabupatenKota_1 = function(feature, resolution){
    ...
    if (value >= 14000.000000 && value <= 51000.000000) {
        ...
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(236,255,255,0.94)'}),
